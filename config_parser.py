...
class MazeConfig(BaseModel):
    ...
    output_file: str
    config_filename: str | None = Field(default=None, exclude=True)
    perfect: bool
    ...
    def validate_maze_configs(self) -> 'MazeConfig':
        ...
        if self.config_filename and self.output_file == self.config_filename:
            raise ValueError(f"Output file cannot be the configuration file "
                             f"itself ({self.config_filename})")
